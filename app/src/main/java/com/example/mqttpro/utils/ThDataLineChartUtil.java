package com.example.mqttpro.utils;
...
public class ThDataLineChartUtil {
    ...
    //一条曲线
    public ThDataLineChartUtil(LineChart mLineChart, String name, int color) {
    ...
    //多条曲线
    public ThDataLineChartUtil(LineChart mLineChart, List<String> names, List<Integer> colors) {
        this.lineChart = mLineChart;
        leftAxis = lineChart.getAxisLeft();
        rightAxis = lineChart.getAxisRight();
        xAxis = lineChart.getXAxis();
     ...
     * 设置Y轴值
     *
     * @param leftMax Left Y
     * @param leftMin Left Y
     * @param rightMax Right Y
     * @param rightMin Right Y
     * @param leftLabelCount Left Y Scale
     * @param rightLabelCount Right Y Scale
     */
    public void setYAxisPlus(float leftMax, float leftMin, float rightMax, float rightMin, int leftLabelCount, int rightLabelCount){
        ...
        rightAxis.setLabelCount(rightLabelCount, false);
        lineChart.invalidate();
    }
